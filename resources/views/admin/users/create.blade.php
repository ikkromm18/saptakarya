    ...
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
            <form action="{{ route('admin.users.store') }}" method="POST">
                ...
                <button type="submit"
                    class="text-white bg-[#1e3a5f] hover:bg-[#152842] focus:ring-4 focus:outline-none focus:ring-[#1e3a5f]/50 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center transition-colors">Simpan
                    User</button>
            </form>
        </div>
    </div>
