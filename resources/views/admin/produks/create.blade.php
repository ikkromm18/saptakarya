            ...
            <form action="{{ route('admin.produks.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <textarea id="ukuran" name="ukuran" rows="5"
                            ...
                            placeholder="60x160 cm&#10;80x200 cm&#10;100x200 cm&#10;Custom" oninput="rebuildMatrix()">{{ old('ukuran') }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea id="bahan" name="bahan" rows="5"
                            class="w-full px-3.5 py-2.5 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-200 focus:border-blue-400 focus:outline-none transition font-mono"
                            placeholder="Flexi Korea 340gr&#10;Flexi Jerman 440gr&#10;Vinyl Outdoor" oninput="rebuildMatrix()">{{ old('bahan') }}</textarea>
                ...
                <div id="harga-matrix-wrapper">
                    ...
                    <div id="harga-matrix" class="overflow-x-auto rounded-xl border border-gray-200">
                        <p class="text-sm text-gray-400 text-center py-8">Isi ukuran dan/atau bahan di atas untuk
                            menampilkan tabel harga.</p>
                    </div>
                </div>

                {{-- Foto --}}
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1.5">Foto Produk <span
                            class="text-red-500">*</span></label>
                    <div id="drop-zone"
                ...
                <div class="flex items-center justify-end gap-3 pt-2">
                    ...
                    <button type="submit"
                        ...
                        style="background-color:#1e3a5f;">Simpan Produk</button>
                </div>
            </form>
        </div>
    </div>

    @include('admin.produks._harga_matrix_script', ['existingHarga' => old('harga', [])])
@endsection
